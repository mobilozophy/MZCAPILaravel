...
namespace Mobilozophy\MZCAPILaravel\Services\Api\InterestCategory;

use Mobilozophy\MZCAPILaravel\Services\Api\AbstractAPIService;
use Mobilozophy\MZCAPILaravel\Services\Api\Credentials;

class InterestCategoryAPIService extends AbstractAPIService
{
    const ENDPOINT = 'interest-categories';
